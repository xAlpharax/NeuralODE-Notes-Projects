...
DCODNN.load_weights('weights/DCODNN-CELEBA-weights.h5')
...
optimizer = tf.keras.optimizers.Adadelta(5e-3) # Adadelta optimizer #1e-2
...
customvis('CELEBA-DCODNN-30', training_acc, testing_acc, training_loss, testing_loss)

#############################################################

DCODNN.save_weights('weights/DCODNN-CELEBA-30-weights.h5')
