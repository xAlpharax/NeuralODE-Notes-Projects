...
import torch
from odesolvers import odesolver
...
class Checkpointing_Adjoint(torch.autograd.Function):
    ...
    def backward(ctx, grad_output):
        ...
        with torch.set_grad_enabled(True):
            ...
            out1 = torch.autograd.grad(func_eval, z, grad_output, allow_unused=True, retain_graph=True)
            out2 = torch.autograd.grad(func_eval, f_params, grad_output, allow_unused=True, retain_graph=True)
