...
Repository for notes, snippets and projects on NODEs. Includes results after training CNN based networks with diffrent methods on MNIST and CIFAR-10 datasets accordingly.
